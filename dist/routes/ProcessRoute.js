...
/* GET home page. */
processRouter.get( '/processes', ( req, res ) => __awaiter( this, void 0, void 0, function* () {
  ...
  for (const id of processId) {
    ...
    const info = {
      ...
      id: node.id.get(),
      icon: node.icon.get(),
      categories: spinal_service_ticket_1.SpinalServiceTicket.getCategoriesFromProcess( id ),
    };
    nodes.push( info );
  }
